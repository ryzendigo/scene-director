...
| **Wardrobe** *(0.8.7)* | Tracks what everyone is wearing from the prose: put-on and take-off verbs, garment phrases with their colour and cut, attributed by possessive or clause ("her green dress", "he takes the suit off"), strangers ignored, memories and hypotheticals ignored, "naked" clears. Rebuilt from the last 80 messages on every message so swipes and edits never leave stale garments. Shows as a 👗 HUD row and in the sprite and chip tooltips, is sent to the model as a `[WARDROBE — …]` line so outfits stop drifting, and `Wardrobe → costume` rules map what she wears to a costume folder (slip → pajamas, ^nothing → nude) ahead of the time rules |
